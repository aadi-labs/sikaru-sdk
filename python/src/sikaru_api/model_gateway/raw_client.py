    ...
    def capture_model_gateway_chat_completion(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"v1/projects/{encode_path_param(project_id)}/model-gateway/{encode_path_param(provider)}/chat/completions/capture",
            method="POST",
            json={
                "error": error,
                "metadata": metadata,
...
class AsyncRawModelGatewayClient:

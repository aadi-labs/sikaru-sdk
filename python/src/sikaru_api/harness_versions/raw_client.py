...
class RawHarnessVersionsClient:
    ...
    def create_harness_version(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            method="POST",
            json={
                "baseHarnessProfileId": base_harness_profile_id,
                "baseHarnessVersionId": base_harness_version_id,
...
class AsyncRawHarnessVersionsClient:

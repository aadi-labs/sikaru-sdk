...
from .raw_client import AsyncRawRetentionPoliciesClient, RawRetentionPoliciesClient

# this is used as the default value for optional parameters
OMIT = typing.cast(typing.Any, ...)


class RetentionPoliciesClient:
    def __init__(self, *, client_wrapper: SyncClientWrapper):
        self._raw_client = RawRetentionPoliciesClient(client_wrapper=client_wrapper)

    @property
    def with_raw_response(self) -> RawRetentionPoliciesClient:
        """
        Retrieves a raw implementation of this client that returns raw responses.

        Returns
        -------
        RawRetentionPoliciesClient
        """
    ...
    def create_retention_policy_update(
        ...
        *,
        ...
        """
        _response = self._raw_client.create_retention_policy_update(
            project_id,
            trace_ids=trace_ids,
            agent_id=agent_id,
...
class AsyncRetentionPoliciesClient:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        self._raw_client = AsyncRawRetentionPoliciesClient(client_wrapper=client_wrapper)

    @property
    def with_raw_response(self) -> AsyncRawRetentionPoliciesClient:
        """
        Retrieves a raw implementation of this client that returns raw responses.

        Returns
        -------
        AsyncRawRetentionPoliciesClient
        """
        return self._raw_client
    ...
    async def create_retention_policy_update(
        ...
        *,
        ...
        async def main() -> None:
            await client.retention_policies.create_retention_policy_update(
                project_id="project_id",
                trace_ids=["traceIds"],
            )
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.create_retention_policy_update(
            project_id,
            trace_ids=trace_ids,
            agent_id=agent_id,
            backfill_window=backfill_window,

...
class RawWorkflowIntentsClient:
    ...
    def create_project_workflow_intent(
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"v1/projects/{encode_path_param(project_id)}/workflow-intents",
            method="POST",
            json={
    ...
    def compile_project_workflow_intent(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/projects/{encode_path_param(project_id)}/workflow-intents/{encode_path_param(intent_id)}/compile",
            method="POST",
            request_options=request_options,
        )
        try:
...
class AsyncRawWorkflowIntentsClient:

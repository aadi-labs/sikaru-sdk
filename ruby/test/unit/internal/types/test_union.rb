...
describe Sikaru::Internal::Types::Union do
  class Rectangle < Sikaru::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < Sikaru::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < Sikaru::Internal::Types::Model

...
describe Sikaru::Internal::Types::Utils do
  Utils = Sikaru::Internal::Types::Utils

  module TestUtils
    class M < Sikaru::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < Sikaru::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < Sikaru::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = Sikaru::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { Sikaru::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      StringArray = Sikaru::Internal::Types::Array[String]
      ModelArray = -> { Sikaru::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { Sikaru::Internal::Types::Array[TestUtils::U] }

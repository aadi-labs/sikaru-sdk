...
describe Sikaru::Internal::Types::Model do
  ...
  class ExampleModel < Sikaru::Internal::Types::Model
    field :name, String
  ...
  class ExampleWithBooleans < Sikaru::Internal::Types::Model
    field :enabled, Sikaru::Internal::Types::Boolean
    field :archived, Sikaru::Internal::Types::Boolean, default: true
  end

  class ExampleWithFalseDefault < Sikaru::Internal::Types::Model
    field :archived, Sikaru::Internal::Types::Boolean, default: false
  end

  class ExampleChild < Sikaru::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < Sikaru::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < Sikaru::Internal::Types::Model

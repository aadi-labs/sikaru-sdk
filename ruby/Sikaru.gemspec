...
require_relative "lib/Sikaru/version"
...
Gem::Specification.new do |spec|
  spec.name = "Sikaru"
  spec.authors = ["Sikaru"]
  spec.version = Sikaru::VERSION
  spec.summary = "Ruby client library for the Sikaru API"
  spec.description = "The Sikaru Ruby library provides convenient access to the Sikaru API from Ruby."

...
module Sikaru
  module ContextRegistry
    class Client
      ...
      # @param params [Sikaru::ContextRegistry::Types::CreateContextRegistryChangeRequest]
      ...
      def create_context_registry_change(request_options: {}, **params)
        params = Sikaru::Internal::Types::Utils.normalize_keys(params)
        request_data = Sikaru::ContextRegistry::Types::CreateContextRegistryChangeRequest.new(params).to_h
        ...
        request = Sikaru::Internal::JSON::Request.new(
          ...
          method: "POST",
          path: "v1/projects/#{URI.encode_uri_component(params[:project_id].to_s)}/context-registry",
          body: body,

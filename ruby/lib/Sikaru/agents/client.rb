...
module Sikaru
  module Agents
    class Client
      ...
      # @param params [Sikaru::Agents::Types::CreateManagedSessionRequest]
      ...
      def create_managed_session(request_options: {}, **params)
        params = Sikaru::Internal::Types::Utils.normalize_keys(params)
        request_data = Sikaru::Agents::Types::CreateManagedSessionRequest.new(params).to_h
        non_body_param_names = %w[project_id agent_id]
        body = request_data.except(*non_body_param_names)

        request = Sikaru::Internal::JSON::Request.new(
          base_url: request_options[:base_url],
          method: "POST",
          path: "v1/projects/#{URI.encode_uri_component(params[:project_id].to_s)}/agents/#{URI.encode_uri_component(params[:agent_id].to_s)}/sessions",
          body: body,

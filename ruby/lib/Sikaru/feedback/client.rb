...
module Sikaru
  module Feedback
    class Client
      ...
      # @param params [Sikaru::Feedback::Types::CreateFeedbackRequest]
      ...
      def create_feedback(request_options: {}, **params)
        ...
        request_data = Sikaru::Feedback::Types::CreateFeedbackRequest.new(params).to_h
        ...
        request = Sikaru::Internal::JSON::Request.new(
          ...
          method: "POST",
          path: "v1/projects/#{URI.encode_uri_component(params[:project_id].to_s)}/feedback",
          body: body,

...
module Sikaru
  module HarnessVersions
    class Client
      ...
      # @param params [Sikaru::HarnessVersions::Types::CreateHarnessVersionRequest]
      ...
      def create_harness_version(request_options: {}, **params)
        params = Sikaru::Internal::Types::Utils.normalize_keys(params)
        request_data = Sikaru::HarnessVersions::Types::CreateHarnessVersionRequest.new(params).to_h
        ...
        request = Sikaru::Internal::JSON::Request.new(
          ...
          method: "POST",
          path: "v1/projects/#{URI.encode_uri_component(params[:project_id].to_s)}/harness-versions",
          body: body,

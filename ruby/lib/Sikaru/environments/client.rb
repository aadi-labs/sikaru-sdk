...
module Sikaru
  module Environments
    class Client
      ...
      def list_managed_environments(request_options: {}, **params)
        params = Sikaru::Internal::Types::Utils.normalize_keys(params)
        request = Sikaru::Internal::JSON::Request.new(
          base_url: request_options[:base_url],
          method: "GET",
          path: "v1/projects/#{URI.encode_uri_component(params[:project_id].to_s)}/environments",
      ...
      # @param request_options [Hash]
      # @param params [Sikaru::Environments::Types::CreateManagedEnvironmentRequest]
      # @option request_options [String] :base_url
      # @option request_options [Hash{String => Object}] :additional_headers
      # @option request_options [Hash{String => Object}] :additional_query_parameters
      # @option request_options [Hash{String => Object}] :additional_body_parameters
      ...
      #
      # @return [Hash[String, Object]]
      def create_managed_environment(request_options: {}, **params)
        params = Sikaru::Internal::Types::Utils.normalize_keys(params)
        request_data = Sikaru::Environments::Types::CreateManagedEnvironmentRequest.new(params).to_h

...
module Sikaru
  module EvalSeeds
    class Client
      ...
      # @param params [Sikaru::EvalSeeds::Types::CreateEvalSeedRequest]
      ...
      def create_eval_seed(request_options: {}, **params)
        params = Sikaru::Internal::Types::Utils.normalize_keys(params)
        request_data = Sikaru::EvalSeeds::Types::CreateEvalSeedRequest.new(params).to_h
        ...
        request = Sikaru::Internal::JSON::Request.new(
          ...
          method: "POST",
          path: "v1/projects/#{URI.encode_uri_component(params[:project_id].to_s)}/eval-seeds",
          body: body,

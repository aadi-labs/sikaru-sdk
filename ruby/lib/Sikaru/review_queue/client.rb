...
module Sikaru
  module ReviewQueue
    class Client
      ...
      # @param params [Sikaru::ReviewQueue::Types::CreateReviewQueueItemRequest]
      ...
      def create_review_queue_item(request_options: {}, **params)
        params = Sikaru::Internal::Types::Utils.normalize_keys(params)
        request_data = Sikaru::ReviewQueue::Types::CreateReviewQueueItemRequest.new(params).to_h
        ...
        request = Sikaru::Internal::JSON::Request.new(
          ...
          method: "POST",
          path: "v1/projects/#{URI.encode_uri_component(params[:project_id].to_s)}/review-queue",
          body: body,

...
module Sikaru
  module ReleaseWatches
    class Client
      ...
      # @param params [Sikaru::ReleaseWatches::Types::CreateReleaseWatchRequest]
      ...
      def create_release_watch(request_options: {}, **params)
        params = Sikaru::Internal::Types::Utils.normalize_keys(params)
        request_data = Sikaru::ReleaseWatches::Types::CreateReleaseWatchRequest.new(params).to_h
        ...
        request = Sikaru::Internal::JSON::Request.new(
          ...
          method: "POST",
          path: "v1/projects/#{URI.encode_uri_component(params[:project_id].to_s)}/release-watches",
          body: body,

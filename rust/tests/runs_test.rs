...
async fn test_runs_start_with_wiremock() {
    ...
    wire_test_utils::verify_request_count(
        "POST",
        "/v1/projects/project_id/harnesses/harness_id/runs",
        None,
        1,
    )
    .await
...
#[tokio::test]
#[allow(unused_variables, unreachable_code)]
async fn test_runs_get_with_wiremock() {
    wire_test_utils::reset_wiremock_requests().await.unwrap();
    let wiremock_base_url = wire_test_utils::get_wiremock_base_url();
    ...
    wire_test_utils::verify_request_count("GET", "/v1/projects/project_id/runs/run_id", None, 1)
        .await
        .unwrap();
}
...
#[tokio::test]
#[allow(unused_variables, unreachable_code)]
async fn test_runs_pending_actions_with_wiremock() {
    wire_test_utils::reset_wiremock_requests().await.unwrap();
    let wiremock_base_url = wire_test_utils::get_wiremock_base_url();
    ...
    wire_test_utils::verify_request_count(
        "GET",
        "/v1/projects/project_id/runs/run_id/actions",
        None,
        1,
    )
    .await
...
#[tokio::test]
#[allow(unused_variables, unreachable_code)]
async fn test_runs_cancel_with_wiremock() {
    wire_test_utils::reset_wiremock_requests().await.unwrap();
    let wiremock_base_url = wire_test_utils::get_wiremock_base_url();
...
#[tokio::test]
#[allow(unused_variables, unreachable_code)]
async fn test_runs_events_with_wiremock() {
    wire_test_utils::reset_wiremock_requests().await.unwrap();
    let wiremock_base_url = wire_test_utils::get_wiremock_base_url();
...
#[tokio::test]
#[allow(unused_variables, unreachable_code)]
async fn test_runs_stream_events_with_wiremock() {
    wire_test_utils::reset_wiremock_requests().await.unwrap();
    let wiremock_base_url = wire_test_utils::get_wiremock_base_url();
    ...
    wire_test_utils::verify_request_count(
        "GET",
        "/v1/projects/project_id/runs/run_id/events/stream",
        None,
        1,
    )
    .await
...
#[tokio::test]
#[allow(unused_variables, unreachable_code)]
async fn test_runs_recover_with_wiremock() {
    wire_test_utils::reset_wiremock_requests().await.unwrap();
    let wiremock_base_url = wire_test_utils::get_wiremock_base_url();
    ...
    wire_test_utils::verify_request_count(
        "POST",
        "/v1/projects/project_id/runs/run_id/recover",
        None,
        1,
    )
    .await
...
#[tokio::test]
#[allow(unused_variables, unreachable_code)]
async fn test_runs_decide_approval_with_wiremock() {
    wire_test_utils::reset_wiremock_requests().await.unwrap();
    let wiremock_base_url = wire_test_utils::get_wiremock_base_url();
...
#[tokio::test]
#[allow(unused_variables, unreachable_code)]
async fn test_runs_submit_tool_result_with_wiremock() {
    wire_test_utils::reset_wiremock_requests().await.unwrap();
    let wiremock_base_url = wire_test_utils::get_wiremock_base_url();
    ...
    wire_test_utils::verify_request_count(
        "POST",
        "/v1/projects/project_id/runs/run_id/tool-results",
        None,
        1,
    )
    .await
...
#[tokio::test]
#[allow(unused_variables, unreachable_code)]
async fn test_runs_get_trajectory_with_wiremock() {
    wire_test_utils::reset_wiremock_requests().await.unwrap();
    let wiremock_base_url = wire_test_utils::get_wiremock_base_url();
    ...
    wire_test_utils::verify_request_count(
        "GET",
        "/v1/projects/project_id/runs/run_id/trajectory",
        None,
        1,
    )
    .await

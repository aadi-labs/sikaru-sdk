...
async fn test_agent_budgets_get_with_wiremock() {
    ...
    wire_test_utils::verify_request_count(
        "GET",
        "/v1/projects/project_id/harnesses/harness_id/budget",
        None,
        1,
    )
    .await
...
#[tokio::test]
#[allow(unused_variables, unreachable_code)]
async fn test_agent_budgets_configure_auto_reload_with_wiremock() {
    wire_test_utils::reset_wiremock_requests().await.unwrap();
    let wiremock_base_url = wire_test_utils::get_wiremock_base_url();
...
#[tokio::test]
#[allow(unused_variables, unreachable_code)]
async fn test_agent_budgets_add_with_wiremock() {
    wire_test_utils::reset_wiremock_requests().await.unwrap();
    let wiremock_base_url = wire_test_utils::get_wiremock_base_url();
...
#[tokio::test]
#[allow(unused_variables, unreachable_code)]
async fn test_agent_budgets_setup_payment_method_with_wiremock() {
    wire_test_utils::reset_wiremock_requests().await.unwrap();
    let wiremock_base_url = wire_test_utils::get_wiremock_base_url();

...
async fn test_execution_sessions_list_with_wiremock() {
    ...
    wire_test_utils::verify_request_count(
        "GET",
        "/v1/projects/project_id/execution-sessions",
        None,
        1,
    )
    .await
...
#[tokio::test]
#[allow(unused_variables, unreachable_code)]
async fn test_execution_sessions_get_with_wiremock() {
    wire_test_utils::reset_wiremock_requests().await.unwrap();
    let wiremock_base_url = wire_test_utils::get_wiremock_base_url();
    ...
    wire_test_utils::verify_request_count(
        "GET",
        "/v1/projects/project_id/execution-sessions/session_id",
        None,
        1,
    )
    .await
...
#[tokio::test]
#[allow(unused_variables, unreachable_code)]
async fn test_execution_sessions_branch_with_wiremock() {
    wire_test_utils::reset_wiremock_requests().await.unwrap();
    let wiremock_base_url = wire_test_utils::get_wiremock_base_url();
...
#[tokio::test]
#[allow(unused_variables, unreachable_code)]
async fn test_execution_sessions_list_files_with_wiremock() {
    wire_test_utils::reset_wiremock_requests().await.unwrap();
    let wiremock_base_url = wire_test_utils::get_wiremock_base_url();
...
#[tokio::test]
#[allow(unused_variables, unreachable_code)]
async fn test_execution_sessions_delete_file_with_wiremock() {
    wire_test_utils::reset_wiremock_requests().await.unwrap();
    let wiremock_base_url = wire_test_utils::get_wiremock_base_url();
...
#[tokio::test]
#[allow(unused_variables, unreachable_code)]
async fn test_execution_sessions_download_file_with_wiremock() {
    wire_test_utils::reset_wiremock_requests().await.unwrap();
    let wiremock_base_url = wire_test_utils::get_wiremock_base_url();
...
#[tokio::test]
#[allow(unused_variables, unreachable_code)]
async fn test_execution_sessions_list_session_inputs_with_wiremock() {
    wire_test_utils::reset_wiremock_requests().await.unwrap();
    let wiremock_base_url = wire_test_utils::get_wiremock_base_url();
...
#[tokio::test]
#[allow(unused_variables, unreachable_code)]
async fn test_execution_sessions_create_with_wiremock() {
    wire_test_utils::reset_wiremock_requests().await.unwrap();
    let wiremock_base_url = wire_test_utils::get_wiremock_base_url();

...
func (r *RawClient) CreateProjectWorkflowIntent(
	ctx context.Context,
	projectID string,
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/v1/projects/%v/workflow-intents",
		projectID,
	)
...
func (r *RawClient) CompileProjectWorkflowIntent(
	ctx context.Context,
	projectID string,
	intentID string,
	opts ...option.RequestOption,
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/v1/projects/%v/workflow-intents/%v/compile",
		projectID,
		intentID,
	)
	headers := internal.MergeHeaders(

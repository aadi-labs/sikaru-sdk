...
//	    "project_id",
//	)
func (c *Client) ListManagedAgents(
	ctx context.Context,
	projectID string,
	opts ...option.RequestOption,
) (map[string]any, error) {
	response, err := c.WithRawResponse.ListManagedAgents(
		ctx,
		projectID,
		opts...,
	)
...
//	    request,
//	)
func (c *Client) CreateManagedAgent(
	ctx context.Context,
	projectID string,
	request *_go.CreateManagedAgentRequest,
	opts ...option.RequestOption,
) (map[string]any, error) {
	response, err := c.WithRawResponse.CreateManagedAgent(
		ctx,
		projectID,
		request,
		opts...,

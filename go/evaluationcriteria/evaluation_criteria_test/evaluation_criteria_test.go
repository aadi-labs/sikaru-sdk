...
package evaluation_criteria_test
...
func TestEvaluationCriteriaListCriteriaWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.EvaluationCriteria.ListCriteria(
		context.TODO(),
		"project_id",
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestEvaluationCriteriaListCriteriaWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestEvaluationCriteriaListCriteriaWithWireMock", "GET", "/v1/projects/project_id/evaluation-criteria", nil, 1)
}

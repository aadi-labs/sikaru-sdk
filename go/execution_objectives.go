...
var (
	...
	objectiveInputFieldMaxRounds      = big.NewInt(1 << 3)
	objectiveInputFieldObjective      = big.NewInt(1 << 4)
	objectiveInputFieldRunID          = big.NewInt(1 << 5)
	objectiveInputFieldSessionID      = big.NewInt(1 << 6)
)
...
type ObjectiveInput struct {
	...
	MaxRounds      *int     `json:"max_rounds,omitempty" url:"-"`
...
// SetMaxRounds sets the MaxRounds field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (o *ObjectiveInput) SetMaxRounds(maxRounds *int) {
	o.MaxRounds = maxRounds
	o.require(objectiveInputFieldMaxRounds)
}

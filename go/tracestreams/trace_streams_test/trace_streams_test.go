...
func TestTraceStreamsStreamOpeninferenceSpansWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.TraceStreams.StreamOpeninferenceSpans(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestTraceStreamsStreamOpeninferenceSpansWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestTraceStreamsStreamOpeninferenceSpansWithWireMock", "POST", "/v1/trace-streams", nil, 1)
}

...
func TestHarnessVersionsCreateHarnessVersionWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.HarnessVersions.CreateHarnessVersion(
		context.TODO(),
		"project_id",
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestHarnessVersionsCreateHarnessVersionWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestHarnessVersionsCreateHarnessVersionWithWireMock", "POST", "/v1/projects/project_id/harness-versions", nil, 1)
}

...
func TestExecutionsExecutionRuntimeLineageWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Executions.ExecutionRuntimeLineage(
		context.TODO(),
		"project_id",
		"trace_id",
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestExecutionsExecutionRuntimeLineageWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestExecutionsExecutionRuntimeLineageWithWireMock", "GET", "/v1/projects/project_id/executions/trace_id/runtime", map[string]interface{}{"account_id": "account_id"}, 1)
}

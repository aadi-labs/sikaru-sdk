...
func TestEvalSeedsCreateEvalSeedWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.EvalSeeds.CreateEvalSeed(
		context.TODO(),
		"project_id",
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestEvalSeedsCreateEvalSeedWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestEvalSeedsCreateEvalSeedWithWireMock", "POST", "/v1/projects/project_id/eval-seeds", nil, 1)
}

...
func (r *RawClient) RegisterToolProvider(
	ctx context.Context,
	projectID string,
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/v1/projects/%v/tool-providers",
		projectID,
	)
...
func (r *RawClient) AttachSourceToolSkill(
	ctx context.Context,
	projectID string,
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/v1/projects/%v/tool-providers/%v/skills",
		projectID,
		toolProviderID,
	)
	headers := internal.MergeHeaders(

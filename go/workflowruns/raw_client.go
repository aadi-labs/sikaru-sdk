...
func (r *RawClient) ProjectWorkflowRunEvents(
	ctx context.Context,
	projectID string,
	runID string,
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/v1/projects/%v/workflow-runs/%v/events",
		projectID,
		runID,
	)
...
func (r *RawClient) RecoverProjectWorkflowRun(
	ctx context.Context,
	projectID string,
	runID string,
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/v1/projects/%v/workflow-runs/%v/recover",
		projectID,
		runID,
	)
	headers := internal.MergeHeaders(

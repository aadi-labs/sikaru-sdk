...
func TestEvaluatorRunsCreateEvaluatorRunWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.EvaluatorRuns.CreateEvaluatorRun(
		context.TODO(),
		"project_id",
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestEvaluatorRunsCreateEvaluatorRunWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestEvaluatorRunsCreateEvaluatorRunWithWireMock", "POST", "/v1/projects/project_id/evaluator-runs", nil, 1)
}

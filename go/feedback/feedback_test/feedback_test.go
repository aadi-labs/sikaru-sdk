...
func TestFeedbackCreateFeedbackWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Feedback.CreateFeedback(
		context.TODO(),
		"project_id",
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestFeedbackCreateFeedbackWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestFeedbackCreateFeedbackWithWireMock", "POST", "/v1/projects/project_id/feedback", nil, 1)
}

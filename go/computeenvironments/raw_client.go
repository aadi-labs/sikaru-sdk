...
func (r *RawClient) Create(
...
) (*core.Response[*_go.EnvironmentView], error) {
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/v1/projects/%v/compute-environments",
		projectID,
	)
	...
	var response *_go.EnvironmentView
	...
	return &core.Response[*_go.EnvironmentView]{
...
func (r *RawClient) Get(
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/v1/projects/%v/compute-environments/%v",
		projectID,
		environmentID,
	)
	headers := internal.MergeHeaders(
...
func (r *RawClient) Disable(
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/v1/projects/%v/compute-environments/%v/disable",
		projectID,
		environmentID,
	)
	headers := internal.MergeHeaders(

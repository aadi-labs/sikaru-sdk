...
func TestSettersCreateProductWorkflowIntentRequest(t *testing.T) {
	t.Run("SetDescription", func(t *testing.T) {
		obj := &CreateProductWorkflowIntentRequest{}
...
func TestSettersMarkExplicitCreateProductWorkflowIntentRequest(t *testing.T) {

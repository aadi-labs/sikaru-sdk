...
extension Requests {
    public struct CreateReviewQueueItemRequest: Codable, Hashable, Sendable {
        public let action: CreateReviewQueueItemRequestAction?
        ...
        public init(
            action: CreateReviewQueueItemRequestAction? = nil,
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.action = try container.decodeIfPresent(CreateReviewQueueItemRequestAction.self, forKey: .action)

...
public final class HarnessesClient: Sendable {
    ...
    public func getInvoiceBudget(projectId: String, harnessId: String, requestOptions: RequestOptions? = nil) async throws -> InvoiceBudget {
        return try await httpClient.performRequest(
            method: .get,
            path: "/v1/projects/\(projectId)/harnesses/\(harnessId)/budget/invoice",
            requestOptions: requestOptions,
            responseType: InvoiceBudget.self
        )
    }
    ...
    ///
    /// - Parameter requestOptions: Additional options for configuring the request, such as custom headers or timeout settings.
    public func getSubscription(projectId: String, harnessId: String, requestOptions: RequestOptions? = nil) async throws -> SubscriptionStatus {
        return try await httpClient.performRequest(
            method: .get,
            path: "/v1/projects/\(projectId)/harnesses/\(harnessId)/budget/subscription",
            requestOptions: requestOptions,
    ...
    ///
    /// - Parameter requestOptions: Additional options for configuring the request, such as custom headers or timeout settings.
    public func subscribe(projectId: String, harnessId: String, request: Requests.SubscriptionInput, requestOptions: RequestOptions? = nil) async throws -> SubscriptionSetup {
        return try await httpClient.performRequest(
            method: .post,
            path: "/v1/projects/\(projectId)/harnesses/\(harnessId)/budget/subscription",
            body: request,
            ...
            responseType: SubscriptionSetup.self
        )
    }
    ...
    ///
    /// - Parameter requestOptions: Additional options for configuring the request, such as custom headers or timeout settings.
    public func cancelSubscription(projectId: String, harnessId: String, requestOptions: RequestOptions? = nil) async throws -> SubscriptionCancellation {
        return try await httpClient.performRequest(
            method: .post,
            path: "/v1/projects/\(projectId)/harnesses/\(harnessId)/budget/subscription/cancel",
            requestOptions: requestOptions,
            retriesDisabled: true,
            responseType: SubscriptionCancellation.self
        )
    }

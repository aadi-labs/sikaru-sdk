...
export class RunsClient {
     ...
     */
    public streamEvents(project_id: string, run_id: string, request: Sikaru.StreamEventsRunsRequest = {}, requestOptions?: RunsClient.RequestOptions): core.HttpResponsePromise<core.Stream<Sikaru.RunEvent>> {
        return core.HttpResponsePromise.fromPromise(this.__streamEvents(project_id, run_id, request, requestOptions));
    }
    ...
    private async __streamEvents(project_id: string, run_id: string, request: Sikaru.StreamEventsRunsRequest = {}, requestOptions?: RunsClient.RequestOptions): Promise<core.WithRawResponse<core.Stream<Sikaru.RunEvent>>> {
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/v1/projects/{project_id}/runs/{run_id}/events/stream");
    }
     ...
     */
    public getTrajectory(project_id: string, run_id: string, requestOptions?: RunsClient.RequestOptions): core.HttpResponsePromise<Record<string, unknown>> {
        return core.HttpResponsePromise.fromPromise(this.__getTrajectory(project_id, run_id, requestOptions));
    }

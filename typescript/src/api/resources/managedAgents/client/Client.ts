...
export declare namespace ManagedAgentsClient {
...
export class ManagedAgentsClient {
    protected readonly _options: NormalizedClientOptionsWithAuth<ManagedAgentsClient.Options>;

    constructor(options: ManagedAgentsClient.Options = {}) {
     ...
     */
    public listManagedAgents(project_id: string, requestOptions?: ManagedAgentsClient.RequestOptions): core.HttpResponsePromise<Record<string, unknown>> {
        return core.HttpResponsePromise.fromPromise(this.__listManagedAgents(project_id, requestOptions));
    }
    ...
    private async __listManagedAgents(project_id: string, requestOptions?: ManagedAgentsClient.RequestOptions): Promise<core.WithRawResponse<Record<string, unknown>>> {
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/v1/projects/{project_id}/managed-agents");
    }

    /**
     * @param {string} project_id
     * @param {Sikaru.CreateManagedAgentRequest} request
     * @param {ManagedAgentsClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Sikaru.UnprocessableEntityError}
     * @throws {@link errors.SikaruError}

...
export type BaseClientOptions = {
    environment?: core.Supplier<environments.SikaruEnvironment | string>;
...
export function normalizeClientOptions<T extends BaseClientOptions = BaseClientOptions>(
    ...
    const headers = mergeHeaders(
        { "X-Fern-Language": "JavaScript", "X-Fern-SDK-Name": "@sikaru/sdk", "X-Fern-SDK-Version": "0.1.0", "User-Agent": "@sikaru/sdk/0.1.0", "X-Fern-Runtime": core.RUNTIME.type, "X-Fern-Runtime-Version": core.RUNTIME.version },
        options?.headers
    );

...
describe("ComputeOperationsClient", () => {
    ...
    test("poll (1)", async () => {
        ...
        const rawResponseBody = { "attachment" : { "capabilities" : [ "capabilities" ] , "cleanup_at" : 1.1 , "cleanup_status" : "unconfirmed" , "environment_id" : "environment_id" , "id" : "id" , "journal_id" : "journal_id" , "lease_ttl_seconds" : 1 , "lease_until" : 1.1 , "owner_epoch" : 1 , "owner_id" : "owner_id" , "processes" : [ { "evidence" : "evidence" , "handle_id" : "handle_id" , "status" : "running" } ] , "project_id" : "project_id" , "protocol_version" : "protocol_version" , "provider_id" : "provider_id" , "session_id" : "session_id" , "startup_deadline" : 1.1 , "status" : "pending" , "uncertain_operations" : [ { "method" : "method" , "owner_epoch" : 1 , "request_digest" : "request_digest" , "run_id" : "run_id" , "tool_call_id" : "tool_call_id" , "workspace_generation" : "workspace_generation" } ] , "workspace_generation" : "workspace_generation" , "workspace_provenance" : { "identity" : "identity" , "kind" : "existing_directory" } } , "execution" : { "approval_required" : true , "run_id" : "run_id" , "status" : "status" , "terminal" : true } , "execution_phase" : "idle" , "issued_operations" : [ { "method" : "method" , "owner_epoch" : 1 , "request_digest" : "request_digest" , "run_id" : "run_id" , "tool_call_id" : "tool_call_id" , "workspace_generation" : "workspace_generation" } ] , "live_handles" : [ { "handle_id" : "handle_id" , "run_id" : "run_id" , "tool_call_id" : "tool_call_id" } ] , "operations" : [ { "arguments" : { "key" : "value" } , "capability_name" : "compute.execute" , "method" : "bash.run" , "owner_epoch" : 1 , "request_digest" : "request_digest" , "run_id" : "run_id" , "tool_call_id" : "tool_call_id" , "tool_provider_id" : "tool_provider_id" , "workspace_generation" : "workspace_generation" } ] , "poll_after_seconds" : 1 , "transport" : "channel" , "workspace_checkpoint" : { "checkpoint_id" : "checkpoint_id" , "owner_epoch" : 1 , "run_id" : "run_id" , "status" : "requested" , "tree_id" : "tree_id" , "workspace_generation" : "workspace_generation" } };
